...
public class Multiplayer extends Screen {
	...
	public void drawHUD(Graphics g) {
		...
		//g.setPaintMode();
		g.setColor(Color.black);
		g.drawRoundRect(115,90,270,150,15,15);
		g.setColor(new Color(0,0,0,85));
		g.fillRoundRect(115,90,270,150,15,15);
		drawButton(g,"Back",125,275,250,40);
		
		g.setFont(new Font("Arial",0,12));
		g.setColor(Color.white);
		g.drawString("FPS:"+getMain().getFPS(), 0,10);
		g.drawString("Looking for other players"+Utility.getDots(), 120,107);
